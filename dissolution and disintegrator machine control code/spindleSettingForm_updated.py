...
ledon = 33 #heater #old value 11

channel =38 #input counter # old value 13
...
img =Image.open( "/home/pi/disintegrator/images/oscillationFrame.jpg")
...
GPIO.add_event_detect(channel, GPIO.RISING, callback=lambda x:mycounter(),bouncetime=100)
...
class SpindleSettingForm:
    ...
    def __init__(self,root):
        ...
        self.cs = 40 #chip select old value 7, cable color Green
        self.sck = 29 # data out (DO) old value 22 blue
        self.so = 35 #clock old value 18 color yellow
...
#         lbl.place(x=50,y=80)
        ...
        self.temperatureEntry.insert(0,"42")
